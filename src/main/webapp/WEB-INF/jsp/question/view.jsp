				...
				<div class="span10">
					<div class="question">
						...
						<form method="post" action="<c:url value="/question/answer/add"/>">
						  <fieldset>
						    <label><b>你的回答</b></label>
						    <input name="questionId" type="hidden" value="${question.id}">
						    <textarea class="text required span12" id="content" name="content" rows="5" ></textarea>
						    <input class="btn btn-primary" name="commit" type="submit" value="回答">
						  </fieldset>
						</form>
					</div>
